...
func UpdatePlace(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
		var data model.PlaceUpdate
		...
		business := business.NewUpdatePlaceBiz(storage)

		if err := business.UpdatePlace(ctx, id, &data); err != nil {
