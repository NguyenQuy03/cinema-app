...
func UpdateCinema(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
		var data model.CinemaUpdate
		...
		business := business.NewUpdateCinemaBiz(storage)

		if err := business.UpdateCinema(ctx, id, &data); err != nil {
