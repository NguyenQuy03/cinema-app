...
func DeleteTheater(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
		...
		business := business.NewDeleteTheaterBiz(storage)

		if err := business.DeleteTheaterById(ctx.Request.Context(), id); err != nil {
